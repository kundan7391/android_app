...
import '../models/society_manager_regi_data.dart';

class SocietyManagerRegistrationForm extends StatefulWidget {
  @override
  _SocietyManagerRegistrationFormState createState() =>
      _SocietyManagerRegistrationFormState();
}

class _SocietyManagerRegistrationFormState
    extends State<SocietyManagerRegistrationForm> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Society Manager Registration'),
      ),
      body: Padding(
        padding: const EdgeInsets.all(16.0),
        child: SingleChildScrollView(
          child: Form(
            // Assign the key to the Form widget
            key: _formKey,
            child: Column(
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    if (_formKey.currentState!.validate()) {
                      ...
                      society_manager_post(selectedStateId, selectedCityId,
                          selectedPincodeId, email, username, password, phone);
                    }
                  },
                  child: Text('Register'),
                ),
